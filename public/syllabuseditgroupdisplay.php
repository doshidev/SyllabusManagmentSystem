...
<?php 
$query_params = checkQueryParams(array("id", "syllabus_id", "type", "cols"));
  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php if($query_params["type"] == "panel") {?>
          <div class="row">
          <?php foreach($groupdetails as $group){ ?>
            <div class="col-sm-<?php echo (12/$query_params["cols"]); ?>">
        ...
        <?php if($query_params["type"] == "accordian") {?>
