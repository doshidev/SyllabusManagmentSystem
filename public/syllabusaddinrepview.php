...
<div id="page-wrapper">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <li>Inherit / Replication Source</li>
      </ol>
    </div>
  </div>
        ...
        <div class="panel-body">
          ...
          <div class="table-responsive">
            <form role="form" method="post" name="syllabusinrep" id="syllabusinrep">
              ...
              <input class="form-control hidden" name="to" id="to" value="<?php echo $query_params["to"]; ?>">
                    ...
                    <tr <?php echo $header_type == "group" ? "class='warning'" : ""; ?>>
                      ...
                      <td class="text-center">  
                        ...
                        <select class="form-control" name="action<?php echo $header["id"]?>" id=
                          ...
                          <option value="i">Inherit</option>
                          <option value="r">Replicate</option>
                        </select>
                        <?php } ?>
                      </td>
                    </tr>
...
<script>
  ...
  function submitForm(){
    document.forms["syllabusinrep"].action = "syllabusupdateinrep.php";
