...
<nav class="navbar navbar-inverse navbar-fixed-bottom">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><?php echo $query_params["id"];?></a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#description">Course</a></li>
            <li><a href="#description">&nbsp;&nbsp;&nbsp;&nbsp;Course Description</a></li>
            <li><a href="#objective">&nbsp;&nbsp;&nbsp;&nbsp;Course Objective</a></li>
            <li><a href="#methods">&nbsp;&nbsp;&nbsp;&nbsp;Instruction Methods</a></li>
              
            <li role="separator" class="divider"></li>
            <li><a href="#textbook">Textbook &amp; Resources</a></li>

            <li role="separator" class="divider"></li>
            <li><a href="#lessonplan">Course Outline</a></li>
            <li><a href="#lessonplan">&nbsp;&nbsp;&nbsp;&nbsp;Lesson Plan</a></li>

            <li role="separator" class="divider"></li>
            <li><a href="#sample">Sample Panel</a></li>
          </ul>
        </li>
        <li>
...
<div id="page-wrapper">
  ...
  <!-- Overview-->
  <div class="panel panel-warning" id="overview">
  ...
  <div class="panel panel-warning" id="description">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
  ...
  <div class="panel panel-warning" id="objective">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
  ...
  <div class="panel panel-warning" id="methods">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
  ...
  <!-- Text Book & Resources -->
  <div class="panel panel-warning" id="textbook">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
  ...
  <div class="panel panel-warning" id="lessonplan">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
  ...
  <!-- Sample Panel -->
  <div class="panel panel-warning" id="sample">
    <div class="panel-heading">
        <div class="btn-group pull-right">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-gear"></i> <span class="caret"></span>
