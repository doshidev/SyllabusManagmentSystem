...
// $schedule = getVwById("sectionschedule", "SectionId", $syllabus["SectionId"]);
//$faculty = getVwById("section_people", "SectionId", $syllabus["SectionId"]);
?>
    ...
    <div class="col-lg-12">
        <div class="panel panel-<?php echo $button_color[$syllabus["academic_session"]];?>">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-12">
                        <h1><?php echo $syllabus["event_id"]?>: &nbsp;<?php echo $event["EVENT_LONG_NAME"]?></h1>
                    </div>
                </div>
            </div>
            
            <div class="panel-footer">
                <span class="pull-left"><?php echo $department["LONG_DESC"]; ?></span>
                    ...
                    <table class="table table-bordered table-hover">
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $syllabus["section"];?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo $quarter . ", " . $syllabus["academic_year"]; ?></td>
                            </tr>
                            <tr>
                                <td class="text-nowrap">Number of Credits:</td>
                                <td><?php echo $event["CREDITS"]; ?> total credits</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Cancellation #:</td>
                                <td><?php echo $content["cancellation_number"]; ?></td>
                            </tr>
            ...
            <div class="panel-body">
                <div class="list-group">
                    <a href="#" class="list-group-item">
                        ...
                        <span class="lead"><?php // echo $faculty["FIRST_NAME"]; ?></span>
                        <span class="lead"><?php // echo $faculty["LAST_NAME"]; ?></span>
                    </a>
                    <a href="#" class="list-group-item">
